...
To add a Raspberry Pi-based access point to an existing network, see [access-point-BRIDGE.md]
https://github.com/kelsieflynn/raspberrypi-documentation/blob/master/configuration/wireless/access-point-BRIDGE.md
